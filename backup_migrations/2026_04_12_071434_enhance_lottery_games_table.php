...
return new class extends Migration
{
    public function up()
    {
        Schema::table('lottery_games', function (Blueprint $table) {
            ...
            if (!Schema::hasColumn('lottery_games', 'bonus_symbol_id')) {
                $table->unsignedBigInteger('bonus_symbol_id')->nullable();
            }
    ...
    {
        Schema::table('lottery_games', function (Blueprint $table) {
            $table->dropColumn(['min_bet', 'max_bet', 'reel_config', 'paylines', 'bonus_symbol_id', 'free_spins_award', 'jackpot_contribution_rate']);
        });
    }
};
